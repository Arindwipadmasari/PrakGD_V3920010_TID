...
# Part E
# Class Player ini ada fungsi init, screen constraint, update
class Player(Block):
...
# Part C
# Class Ball ada fungsi init, update, restart counter, reset ball dan collisions
class Ball(Block):
...
# Part I
# Class Opponent ada fungsi init, update, dan constraint
...
# Pengaturan tinggi dan panjang Layar
screen_width = 720
screen_height = 480
screen = pygame.display.set_mode((screen_width, screen_height))
pygame.display.set_caption('Pong')

# untuk pengaturan tampilan dan suara di Game
